---
title: From Keyword Cluster to Sitemap — Structure the Site Around the Research
area: research
source_lessons: ["02-10","02-12"]
tools: [ahrefs]
---

# From Keyword Cluster to Sitemap — Structure the Site Around the Research

**What it is.** The bridge between research and building: once you've validated a niche and gathered its keyword cluster, turn that data into a concrete website sitemap. The home page targets the main short-tail keyword; category pages target keyword groups; and long-tail keywords get covered at scale with programmatic SEO — all internally linked back to the converting home-page tool.

**When to use.**
- Research is done and validated, and you need to decide how the site is structured before building.
- You have a head term plus several keyword groups and need to assign them to pages.
- Planning a programmatic-SEO content layer over a core tool/product.
...
- Don't overload the home page with every keyword — give secondary keywords their own pages to avoid diluting the main target.

**Example.** For `AI tattoo generator` (20k/mo, low KD, commercial): home page = the free generator (built richer than competitors). Category hubs = `tattoo ideas`, `tattoo styles`, `tattoo artists near me`. Programmatic layer = a page per `<animal/object> tattoo idea` and per style/location, each showing AI-generated examples and linking up to the home-page tool, which upsells a paid plan. The validated cluster (hundreds of thousands of searches) maps cleanly onto this tree.

**Pitfalls.**
- Cramming every keyword onto the home page and diluting its main target.
